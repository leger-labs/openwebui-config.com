...
function createSchemasFileContent(processed) {
  // The current schema uses a single flat object approach rather than individual schemas
  // We need to extract the properties from the existing OpenWebUIConfig schema
